...
public class QiniuUploadUtils {
    ...
    static String ACCESS_KEY = "31gPM3JZTiWjdzs_ZTITzNCcE5CxYO229wBSS27G";
    static String SECRET_KEY = "qR82jPoiButzeyyn7xvN1MgM0HgnMV-5BUBJwKcy";
    //要上传的空间;对应到七牛上（自己建文件夹 注意设置公开）  
    static String bucketname = "k9511";
    //上传文件的路径 ;本地要上传文件路径  
  //  String FilePath = "C:\\Users\\Administrator\\Pictures\\good\\g1002\\g100201.jpg";
    //七牛云服务器存储空间的域名
    static String yuName = "http://q7d9apgt9.bkt.clouddn.com/";
    //密钥配置  
