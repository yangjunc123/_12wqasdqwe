layui.use(['jquery','layer', 'table','form','upload'], function() {
    ...
    $("#saveRoomsUI").click(function () {
        ...
        //回显原有默认图片
        $('#demo1').attr('src', "http://q7d9apgt9.bkt.clouddn.com/fm1.jpg");
        $("#roomPicId").val("http://q7d9apgt9.bkt.clouddn.com/fm1.jpg");
        //2.将添加界面弹出
        layer.open({
            type:1,  //弹出类型
            title:"客房添加操作界面",  //弹框标题
    ...
    $("#roomNum").blur(function () {
        checkRoomNum($(this).val());  //进行房间号的唯一性验证
    });
    ...
    //    ,data:{"path":"F:\\k9511\\u3\\img"}  //上传的目标文件夹路径
